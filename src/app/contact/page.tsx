...
const coveredStates = ["[State 1]", "[State 2]", "[State 3]", "[State 4]", "[State 5]"];
        ...
        <section className="section-padding bg-white">
          <div className="container-width">
            <div className="grid grid-cols-[55fr_45fr] items-start gap-20 md:grid-cols-1">
              ...
              <aside>
                <h3 className="mb-8 font-display text-[28px] font-bold uppercase text-black">Direct Contact</h3>
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="mb-1 font-body text-[11px] font-medium uppercase tracking-[0.1em] text-mid-grey">Phone</p>
                    <p className="font-body text-[15px] font-medium text-black">+91 XXXX XXXXXX</p>
                    <p className="mt-1 font-body text-[13px] text-mid-grey">Mon-Sat, 9am-7pm IST</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="mb-1 font-body text-[11px] font-medium uppercase tracking-[0.1em] text-mid-grey">WhatsApp</p>
                    <p className="font-body text-[15px] font-medium text-black">
                      +91 XXXX XXXXXX{" "}
                      <a href="https://wa.me/910000000000" className="text-accent transition-colors hover:text-accent-dark">
                        Open WhatsApp -&gt;
                      </a>
                    </p>
                    <p className="mt-1 font-body text-[13px] text-mid-grey">Quick responses</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="mb-1 font-body text-[11px] font-medium uppercase tracking-[0.1em] text-mid-grey">Email</p>
                    <p className="font-body text-[15px] font-medium text-black">info@nbes.in</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="mb-1 font-body text-[11px] font-medium uppercase tracking-[0.1em] text-mid-grey">Location</p>
                    <p className="font-body text-[15px] font-medium text-black">[Address placeholder]</p>
                    <p className="mt-1 font-body text-[13px] text-mid-grey">[City], [State], India</p>
                  </div>
                </div>
              </div>
      ...
      <ScrollRevealBlock>
        <section className="h-[400px] w-full bg-[#e8e7e0]">
          <div className="container-width flex h-full flex-col items-center justify-center gap-3">
            ...
            <p className="font-body text-[14px] text-mid-grey">Map placeholder</p>
          </div>
        </section>
      </ScrollRevealBlock>
    </>
